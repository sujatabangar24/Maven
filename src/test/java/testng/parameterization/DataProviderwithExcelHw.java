...
public class DataProviderwithExcelHw {

    @DataProvider(name = "test data")
    public Object[][] dataProviderWithExcelHw() throws IOException {
        Object[][] arrObj = getDataFromExcel("C:\\Users\\Sujata\\Desktop\\integer.xlsx", "testCase1");
        return arrObj;
    ...
    public void verifyParameter(String seriesNo, String postalAdd) throws InterruptedException {
        ...
        searchTextBox.sendKeys(seriesNo+"  "+postalAdd);
